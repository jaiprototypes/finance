...
from ..models import ImportBatch, ImportRow, Transaction
from ..services.classification import classify_payload, apply_classification
        ...
        try:
            ...
            if auto_classify:
                try:
                    ...
                    result = classify_payload(session, parsed)
                    apply_classification(session, txn.id, result)
                except Exception as exc:
                    # Keep import idempotent even if classification fails.
