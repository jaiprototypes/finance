    ...
    while True:
        ...
        for txn in rows:
            ...
            transaction, _classification_result, classification_error = ledger_ingestion.create_transaction(
                ...
                auto_classify=True,
                classification_payload={"bank_category": up_category_name or up_category_id},
            )
            ...
            if classification_error:
                logger.warning("Auto-classification failed for Up transaction %s: %s", transaction.id, classification_error)
            added += 1
